...
const getCommon = (Stack) => {
  ...
  return [
    <Stack.Screen key="Settings" name="Settings" component={Settings} options={{
      headerTitle: "Settings",
      headerRight: () => {
        return <HeaderRight />
      }
    }} />,
    <Stack.Screen key="Archive" name="Archive" component={Archive} options={{
      headerTitle: "Archive",
      headerRight: () => {
        return <HeaderRight />
      }
    }} />,
    <Stack.Screen key="ListReminder" name="ListReminder" component={ListReminder} options={{
      headerTitle: t("ListReminder:reminderDetail"),
      headerRight: () => {
        return <HeaderRight />
      }
    }} />,
    <Stack.Screen key="EditReminder" name="EditReminder" component={EditReminder} options={{
...
export const MetaScreenNavigator = () => {
  ...
  return (
    <Navigator>
      <Stack.Screen name="Meta" component={Meta} options={{
        headerTitle: "Meta",
        headerRight: () => {
          return <HeaderRight />
        }
